package com.metoo.nrsm.core.config.socket.linux.command;
...
//     ExecutorService fixedThreadPool = Executors.newCachedThreadPool();//
    ...
    private static ExecThreadPool pool = new ExecThreadPool();// 创建单例  lan

    /**
     * 获取一个单例
     * @return
     */
    public static ExecThreadPool getInstance(){
        return pool;
    }
    ...
    public Future<?> submit(Runnable run) {
        return fixedThreadPool.submit(run);
    }
