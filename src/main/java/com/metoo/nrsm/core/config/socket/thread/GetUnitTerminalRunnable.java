 ...
 */
@Slf4j
public class GetUnitTerminalRunnable implements Runnable {
    ...
    public GetUnitTerminalRunnable() {
    }

    public GetUnitTerminalRunnable(String sid, Object params, Map<String, Map<String, String>> taskParams, Map<String, Session> clients) {
        this.sid = sid;
        this.params = params;
    ...
    public void run() {
        ...
        NoticeWebsocketResp resp = terminalService.getUnitTerminal(JSONObject.toJSONString(params));
