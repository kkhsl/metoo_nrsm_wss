 ...
 */
@Slf4j
public class GetTerminalCountRunnable implements Runnable {
    ...
    public GetTerminalCountRunnable() {
    }

    public GetTerminalCountRunnable(String sid, Object params, Map<String, Map<String, String>> taskParams, Map<String, Session> clients) {
        this.sid = sid;
        this.params = params;
    ...
    public void run() {
        ...
        NoticeWebsocketResp resp = terminalService.getTerminalCount(JSONObject.toJSONString(params));
